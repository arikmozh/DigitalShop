...
public class Admin implements Initializable, Serializable{
    ...
    @FXML
    private Text addManager_txt;

    @FXML
    private TextField Mname_txt;

    @FXML
    private TextField Myear_txt;

    @FXML
    private TextField Mphone_txt;
    ...
    @FXML
    private Button addM_btn;

    @FXML
    private Text editManager_txt;

    @FXML
    private TextField edtMname_txt;

    @FXML
    private TextField edtMyear_txt;

    @FXML
    private TextField edtMphone_txt;
    ...
    @FXML
    private AnchorPane TranAnchor;

    @FXML
    private TextArea AllTranArea;

    @FXML
    private Text showAllTra_txt;

    @FXML
    private Button ShowAllTran;

    @FXML
    private Text totalTran_txt;

    @FXML
    private Label totalTran_lbl;
    ...
    @FXML
    void ShowAllTran_btn(ActionEvent event) {
    	AllTranArea.setText(store.getCart().toString());
    	
    	totalTran_lbl.setText(store.getTotalCash());
    }
    ...
    @FXML
    void addM_btn(ActionEvent event) {
    	store.addManager(new Manager(Mname_txt.getText(), Integer.parseInt(Myear_txt.getText()), Mphone_txt.getText()));
    }
    ...
    @FXML
    void editM_btn(ActionEvent event) {
    	store.getManagers().get(Integer.parseInt(id_txt.getText())).set_name(edtMname_txt.getText());
    	store.getManagers().get(Integer.parseInt(id_txt.getText())).set_birthYear(Integer.parseInt(edtMyear_txt.getText()));
    	store.getManagers().get(Integer.parseInt(id_txt.getText())).set_phone(edtMphone_txt.getText());
    }
